...
const StormMap: React.FC<StormMapProps> = ({ storms, focusedStormId, onStormFocus, stormColors }) => {
   ...
   return (
      <div className="w-full h-[500px] bg-hull/40 rounded-sm border border-white/5 shadow-lg backdrop-blur-sm relative overflow-hidden flex flex-col select-none group hover:border-cyan-500/30 transition-all">
         ...
         <div className="absolute top-4 right-4 z-30">
            <button
               ...
               className={`p-2 rounded-sm shadow-lg border transition-all ${showLayersMenu ? 'bg-cyan-900/50 border-cyan-400 text-cyan-100' : 'bg-hull border-white/10 text-slate-400 hover:text-white hover:border-white/30'}`}
               title="Map Layers"
            >
