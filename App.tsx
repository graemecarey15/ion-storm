...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-void text-slate-200 font-sans selection:bg-cyan-500/30 overflow-hidden">
      ...
      {/* Floating Header */}
      <header className="relative z-50 pt-6 px-4 md:px-6 mb-8">
        <div className="max-w-7xl mx-auto">
          <div className="bg-hull/80 backdrop-blur-xl border border-white/5 rounded-2xl shadow-glow-sm px-4 h-16 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="relative group cursor-pointer">
                <div className="absolute inset-0 bg-cyan-500/20 blur-md rounded-full group-hover:bg-cyan-400/30 transition-all"></div>
                <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-900 to-slate-900 border border-cyan-500/30 flex items-center justify-center text-cyan-400 font-mono font-bold text-lg shadow-inner">
                  IO
                </div>
              </div>
              <div>
                <h1 className="text-xl font-bold tracking-widest uppercase text-white font-sans">
                  ION <span className="text-cyan-400">STORM</span>
                </h1>
                <div className="flex items-center gap-2 text-[10px] text-cyan-600 font-mono uppercase tracking-[0.2em]">
                  <span>Hurdat2 Visualization Protocol</span>
                  <span className="w-1 h-1 rounded-full bg-cyan-500 animate-blink"></span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <button
                ...
                className="text-xs transition-colors font-mono uppercase tracking-wider text-slate-500 hover:text-rose-400 px-3 py-1 hover:bg-rose-950/30 rounded"
              ...
              <button
                ...
                disabled={true}
                className={`
                    hidden sm:flex px-4 py-1.5 rounded text-xs font-mono uppercase tracking-wider transition-all items-center gap-2 border
                    border-slate-800 text-slate-600 bg-slate-900/50 opacity-50 cursor-not-allowed
                  `}
              >
                Auto_Save: OFF
              </button>
              ...
              <button
                ...
                className="group relative px-5 py-2 overflow-hidden rounded bg-cyan-900/20 border border-cyan-500/30 text-cyan-400 text-xs font-bold uppercase tracking-wider hover:bg-cyan-500 hover:text-white transition-all shadow-glow-xs hover:shadow-glow-md"
              >
        ...
        {isLoadingDefaults ? (
          <div className="flex flex-col items-center justify-center py-20 animate-fade-in relative z-10">
            <div className="relative w-16 h-16 mb-4">
              ...
              <div className="absolute inset-0 border-t-4 border-cyan-500 rounded-full animate-spin shadow-glow-md"></div>
            </div>
            <h2 className="text-2xl font-bold text-white tracking-wider font-mono">INITIALIZING SYSTEM</h2>
            <p className="text-cyan-500/60 mt-2 text-xs font-mono uppercase tracking-widest animate-pulse">{loadingMessage}</p>
          </div>
        ) : (
          <>
            {/* Control Bar */}
                  ...
                  {presetOptions.map(preset => {
                    return (
                      <button
                        ...
                        title={preset.title}
                        className={`px-3 py-1 text-xs font-bold rounded transition-colors whitespace-nowrap h-full flex items-center ${preset.disabled
